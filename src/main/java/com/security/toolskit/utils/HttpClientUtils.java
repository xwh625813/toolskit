...
//            System.out.println("请求:"+post);
    ...
    public static void main(String[] args) {
        try {
            ...
            map.put("password", "123qweqwe");
            String str=post("http://127.0.0.1:8095/admin/login", JSON.toJSONString(map),"application/json", "UTF-8", 10000, 10000);
//            String str = post("http://127.0.0.1:8095/admin/login", "username=admin&password=123qweqwe",
